      ...
      <div className="mx-auto max-w-2xl px-4  sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div className="flex justify-between ">
          ...
          <div className='flex items-center space-x-4'>
            ...
            <button onClick={handleNext} disabled={currentindex + itemsPerpage >= categories.length} className={`cursor-pointer hover:rounded-full ${currentindex + itemsPerpage >= categories.length?'opacity-25 pointer-events-none':'opacity-1 hover:bg-gray-400 cursor-pointer'} `}><FaAngleRight className="w-6 h-6"/></button>
