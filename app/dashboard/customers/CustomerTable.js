...
const CustomerTable = ({customerTable,deleteCustomer,editCustomerHandler,receiveStateFromTable}) => {
  ...
  const handleEdit = (index) => {
    ...
    receiveStateFromTable()
  
    console.log(index)
    // editCustomerHandler(index);
  };
                            ...
                            <tr key={index}>
                                ...
                                <td className="p-2 whitespace-nowrap">
                                    <div className="text-sm text-left flex gap-2">
                                      <span className="px-2 py-1 text-sky-600"><button onClick={()=>handleEdit(index)}>Edit</button></span>
